		...
		<div id="main" role="main">
			...
			<div id="content">
				<div class="well">
					...
					<h1 class="semi-bold">Mis asi see "Eq History" on?</h1>
					<p> 
						Siin lehel on masina kohta ajalugu, kes on kasutanud ja millal jne....
					</p>
					<p>
						<a class="btn btn-primary" href="eq.php?id=<?php echo $eq["id"];?>">Tagasi masina andmete juurde</a>
					</p>
				</div>
							...
							<div class="jarviswidget" id="wid-id-11" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false">
								<header>
									<h2>Masina <strong><?php echo $eq["name"];?></strong> <i>ajalugu</i></h2>		
								</header>
									        ...
									        <thead>
												<tr>
													...
													<th class="hasinput icon-addon">
														<input id="dateselect_filter" type="text" placeholder="Kuupäev" class="form-control datepicker" data-dateformat="yy-mm-dd">
...
<?php require "scripts.php"; ?>		
		...
		<script>
		    ...
		    var otable = $('#datatable_fixed_column').DataTable({
				...
				"ajax": 'ajax/user/user.php?eqHistory=1&id=<?php echo $eq["id"];?>',
