		...
		<div id="main" role="main">
			...
			<div id="content">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="well">
						<h1 class="semi-bold">What are "Users?"</h1>
						<p>Here you can manage users.</p>
					</div>				
				</div>
				<div class="col-xs-12 errorArea">
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
						<div class="well">
							<button type="button" data-toggle="modal" data-target="#OpenModal" data-id="NewUser" class="btn btn-block btn-success">Add User</button>
						</div>
					</div>
					<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
						<table class="table table-striped table-bordered" id="UserListTable" width="100%">
							<thead>
								<tr>
									<th>Username</th>
									<th>First name</th>
